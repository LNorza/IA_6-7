...
x_values = np.array([X.min(), X.max()])  # Define x_values using the minimum and maximum values from X
y_values = MPG_Pred.predict(x_values)  # Define y_values using the predicted values from x_values
